...
distress_type = st.selectbox("Distress Type", ["Cracking", "Rutting", "Potholes", "Other"])
...
treatment = st.selectbox("Select Treatment", ["Crack Sealing", "Overlay", "Reconstruction", "Other"])
...
if missing:
    ...
    if st.button("Generate M&R Plan"):
        ...
        - **Recommended Treatment**: {treatment} ({ASTM_GUIDANCE['treatment']['standard']})
